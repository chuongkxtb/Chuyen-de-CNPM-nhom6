 ...
 <div class="main">
    <div class="content">
    	<div class="content_top">
    		...
    		<div class="heading">
    		<h3><?php $pd_cat = $cat->products_cat1()->fetch_assoc(); echo $pd_cat['tenloaisp']?></h3>
    		</div>
    		<div class="clear"></div>
    	</div>
	      <div class="section group">
		  <?php
			$pd_cat = $cat->products_cat1();
			if($pd_cat){
		...
		<?php
    		...
    		<div class="heading">
    		<h3><?php $pd_cat = $cat->products_cat2()->fetch_assoc(); echo $pd_cat['tenloaisp']?></h3>
    		</div>
    		<div class="clear"></div>
    	</div>
	      <div class="section group">
		  <?php
			$pd_cat = $cat->products_cat2();
			if($pd_cat){
				while($result = $pd_cat->fetch_assoc()){
